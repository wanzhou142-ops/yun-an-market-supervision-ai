...
_RAW = _BIG_SCREEN / "assets" / "raw"
SRC = {
    "welcome": str(_RAW / "avatar-welcome.png"),
    "corridor": str(_RAW / "avatar-corridor.png"),
    "pharmacy": str(_RAW / "avatar-pharmacy.png"),
}
OUTDIR = str(Path(__file__).resolve().parent / "_tmp_normalized")
